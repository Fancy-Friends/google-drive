 ...
 * connectors. This carries what is true of Google Drive: its base URL, its
...
import { googleDriveFaker } from "./faker.js";
 ...
 */
export function googleDriveAuthorize(
...
/** The Google Drive service, for the TypeScript runtime. */
export const GOOGLE_DRIVE: ServiceDescriptor = {
  service: "google_drive",
  title: "Google Drive",
  sandbox: "none",
  baseUrls: { ...GOOGLE_DRIVE_BASE_URLS },
  requires: [...GOOGLE_DRIVE_REQUIRES],
  authorize: googleDriveAuthorize,
  faker: googleDriveFaker,
};
