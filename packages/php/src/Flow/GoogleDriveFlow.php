 ...
 */
/**
 * Every Google Drive node executor — the PHP twin of
 * `GOOGLE_DRIVE_RUNNABLE_KINDS` in @particle-academy/google-drive-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `GoogleDriveFlow::register($kinds, $executors)` — one call, no directory
 * scan.
 ...
 */
final class GoogleDriveFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        FolderExecutor::class,
    ];
